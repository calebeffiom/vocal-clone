...
const ArticlePreview = ({
    ...
    return (
        <div className="story-flex-cont h-[500px] lg:h-[450px] relative cursor-pointer">
            ...
            <div className="article-writer-details w-[100%] flex items-center justify-between absolute bottom-0">
                <div className="author-cont flex gap-[10px] items-center cursor-pointer" onClick={() => { router.push(`/user/${userName}`) }}>
